...
import org.lb.drools.component.sdk.SdkInfo;
import org.lb.drools.component.service.ActionListenerService;
import org.lb.drools.component.service.IService;
import org.lb.drools.component.service.impl.DeviceClientServiceImpl;
import org.lb.drools.component.filemanager.FileManager;
import org.lb.drools.component.ota.OTAService;
import org.lb.drools.component.service.impl.AbstractServiceImpl;
import org.lb.drools.component.timesync.TimeSyncService;
...
public class AbstractDevice {
    ...
    public AbstractDevice(String serverUri, String deviceId, String deviceSecret) {
        ...
        this.client = new DeviceClientServiceImpl(clientConf, this);
        initSysServices();
    ...
    public void firePropertiesChanged(String serviceId, String... properties) {
        AbstractServiceImpl deviceService = getService(serviceId);
